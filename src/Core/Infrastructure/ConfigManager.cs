    ...
    public class ConfigManager
    {
        ...
        private void EnsureModelDefaults(AppConfig config)
        {
            ...
            if (config.Modes.ContainsKey("HACKER"))
            {
                ...
                {
                    hackerModes.Add(new ModelDefinition { Id = "AudioJak", FileName = "Qwen2-Audio-7B-Instruct-Q8_0.gguf", MmprojFileName = "mmproj-Qwen2-Audio-7B-Instruct-f16.gguf", Port = 8085, ContextSize = 8192, UseFlashAttention = true, KvCacheType = "q8_0" });
                    modified = true;
                }
            }
            ...
            if (config.Modes.ContainsKey("ACCADEMIA"))
            {
                ...
                {
                    accademiaModes.Add(new ModelDefinition { Id = "AudioJak", FileName = "Qwen2-Audio-7B-Instruct-Q8_0.gguf", MmprojFileName = "mmproj-Qwen2-Audio-7B-Instruct-f16.gguf", Port = 8085, ContextSize = 8192, UseFlashAttention = true, KvCacheType = "q8_0" });
                    modified = true;
                }
            }
        ...
        public AppConfig GenerateDefaultConfig()
        {
            ...
            config.Modes["HACKER"] = new List<ModelDefinition>
            {
                ...
                new ModelDefinition { Id = "AudioJak", FileName = "Qwen2-Audio-7B-Instruct-Q8_0.gguf", MmprojFileName = "mmproj-Qwen2-Audio-7B-Instruct-f16.gguf", Port = 8085, ContextSize = 8192, UseFlashAttention = true, KvCacheType = "q8_0" },
